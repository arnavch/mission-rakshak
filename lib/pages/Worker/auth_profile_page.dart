...
class WorkerAuthProfilePage extends StatefulWidget {
  WorkerAuthProfilePage(this.data, this.centerData);
  final Map<String, dynamic> data;
  final Map<String, dynamic> centerData;
  @override
  _WorkerAuthProfilePageState createState() => _WorkerAuthProfilePageState();
}

class _WorkerAuthProfilePageState extends State<WorkerAuthProfilePage> {
  ...
  Future<bool> updateData(UserDatabase database) async {
    await database.updateWorkerUserDataFromProfilePage(
