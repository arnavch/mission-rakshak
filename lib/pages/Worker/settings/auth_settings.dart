...
class WorkerAuthSettingsPage extends StatefulWidget {
  WorkerAuthSettingsPage({
    this.changeToChangePassword,
  });
  final Function changeToChangePassword;

  @override
  _WorkerAuthSettingsPageState createState() => _WorkerAuthSettingsPageState();
}

class _WorkerAuthSettingsPageState extends State<WorkerAuthSettingsPage> {
