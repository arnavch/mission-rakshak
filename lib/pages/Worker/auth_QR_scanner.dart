...
class WorkerQRScanner extends StatefulWidget {
  WorkerQRScanner(this.centerData, this.userData);
  Map<String, dynamic> centerData;
  Map<String, dynamic> userData;
  @override
  _WorkerQRScannerState createState() => _WorkerQRScannerState();
}

class _WorkerQRScannerState extends State<WorkerQRScanner> {
  String uuidcode = '';
