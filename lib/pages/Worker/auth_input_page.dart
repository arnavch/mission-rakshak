...
class WorkerAuthInputPage extends StatefulWidget {
  WorkerAuthInputPage(this.centerData);
  Map<String, dynamic> centerData;
  @override
  _WorkerAuthInputPageState createState() => _WorkerAuthInputPageState();
}

class _WorkerAuthInputPageState extends State<WorkerAuthInputPage> {
...
//TODO: idk but could have to convert DOB into string
  writeUserData() {
    data.updateWorkerUserDataFromSignIn(
